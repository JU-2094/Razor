...
## Grab collision mask
@export (int, LAYERS_3D_PHYSICS) var grab_collision_mask = 1 :
	get:
		return grab_collision_mask # TODOConverter40 Non existent get function 
	set(mod_value):
		mod_value  # TODOConverter40 Copy here content of _set_grab_collision_mask
...
@export var ranged_distance: float = 5.0 :
	get:
		return ranged_distance # TODOConverter40 Non existent get function 
	set(mod_value):
		mod_value  # TODOConverter40 Copy here content of _set_ranged_distance

## Ranged-grab angle
@export (float, 0.0, 45.0) var ranged_angle: float = 5.0 :
	get:
		return ranged_angle # TODOConverter40 Non existent get function 
	set(mod_value):
		mod_value  # TODOConverter40 Copy here content of _set_ranged_angle

## Ranged-grab collision mask
@export (int, LAYERS_3D_PHYSICS) var ranged_collision_mask = 1 :
	get:
		return ranged_collision_mask # TODOConverter40 Non existent get function 
	set(mod_value):
		mod_value  # TODOConverter40 Copy here content of _set_ranged_collision_mask
...
func _update_closest_object() -> void:
	...
	# remove_at highlight checked old object
