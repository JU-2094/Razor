...
@export (int, LAYERS_3D_PHYSICS) var collision_mask = 524288 :
	get:
...
func _ready():
	...
	_sense_area.connect("area_entered",Callable(self,"_on_area_entered"))
	_sense_area.connect("area_exited",Callable(self,"_on_area_exited"))
